                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th> Passport <span class="icon-arrow">&UpArrow;</span></th>
                        ...
                        <?php
						 ...
						 ?>
                                <tr>
                                    ...
                                    <td> <?php echo $aname[$row['departure_airport_id']].' - '.$aname[$row['arrival_airport_id']] ?> </td>
                                    <td> <?php echo date('M d,Y h:i A',strtotime($row['departure_datetime'])) ?> </td>
                                </tr>
                        <?php endwhile; ?>
