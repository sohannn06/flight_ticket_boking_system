                                ...
                                <form id="manage-filter"  action="index.php?page=flights" method="POST">
                                    <div class="row form-group">
                                        <div class="col-sm-3">
                                            ...
                                            ?>
                                                <option value="<?php echo $row['airport_id'] ?>" <?php echo isset($departure_airport_id) && $departure_airport_id == $row['airport_id'] ? "selected" : '' ?>><?php echo $row['location'].", ".$row['airport_name'] ?></option>
                                            <?php endwhile; ?>
                                            </select>
                                        </div>
                                        <div class="col-sm-3">
                                            ...
                                            while($row = $airport->fetch_assoc()):
                                            ?>
                                                <option value="<?php echo $row['airport_id'] ?>" <?php echo isset($arrival_airport_id) && $arrival_airport_id == $row['airport_id'] ? "selected" : '' ?>><?php echo $row['location'].", ".$row['airport_name'] ?></option>
                                            <?php endwhile; ?>
                                            </select>
                                        </div>
                                        <div class="col-sm-3">
	...
	<section class="page-section" id="flight" >
        <div class="container">
        	<div class="card">
				...
				$flight = $conn->query("SELECT f.*,a.airlines FROM flight_list f inner join airlines_list a on f.airline_id = a.airline_id $where order by rand()");
				...
				<div class="row align-items-center">
					<div class="col-md-3">
						<img src="./imgs/gallery-1.png" alt="">
					</div>
					<div class="col-md-6">
