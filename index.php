...
<html lang="en">
    ...
    <style>
    	header.masthead {
		  background: url(./imgs/gallery-2.png);
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg fixed-top py-3 bg-info" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="./">Flight</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="destroy.php">Sign Out</a></li>
                    </ul>
                </div>
            </div>
        </nav>
